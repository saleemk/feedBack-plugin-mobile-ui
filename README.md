...
This repository is currently in a foundation-only state. It installs a modular,
idempotent runtime and applies reversible viewport classification classes to
`<html>`, but it does not change FeedBack layout or visuals yet.
